...
const CategoryWithSubcategories = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div 
        className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-8 mb-6"
        style={categoryData?.backgroundColor ? { background: categoryData.backgroundColor } : {}}
      >
        <div className="container mx-auto px-4">
          <button
            onClick={() => navigate('/')}
            className="flex items-center text-white/90 hover:text-white mb-3 transition"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/80 text-sm mt-1">
                {allProducts.length} product{allProducts.length !== 1 ? 's' : ''} • {subcategories.length} subcategor{subcategories.length !== 1 ? 'ies' : 'y'}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 pb-8">
        ...
        <button
          ...
          className="lg:hidden w-full mb-4 px-4 py-3 bg-white rounded-lg shadow-sm border border-gray-200 flex items-center justify-between"
        >
